...
class ExchangeConfigForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            "spread_bps_usdt_compra": forms.NumberInput(attrs={"step": 1}),
            "spread_bps_usdt_venta":  forms.NumberInput(attrs={"step": 1}),
            "spread_bps_usd_compra":  forms.NumberInput(attrs={"step": 1}),
            "spread_bps_usd_venta":   forms.NumberInput(attrs={"step": 1}),
